...
exports.createUpdateUserProfile = createUpdateUserProfile;
...
function createUpdateUserProfile() {
    const userRepository = new repositories_1.UserRepository();
    return new UpdateUserProfile_1.UpdateUserProfile(userRepository);
}
