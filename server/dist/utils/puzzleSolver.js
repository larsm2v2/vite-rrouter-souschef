...
exports.patternToGrid = patternToGrid;
exports.gridToPattern = gridToPattern;
 ...
 */
function patternToGrid(pattern, size = 5) {
...
function patternToMask(pattern, size = 5) {
    let mask = 0;
...
function solvePuzzle(pattern, size = 5, maxMoves = 20) {
    const startMask = patternToMask(pattern, size);
    if (startMask === 0)
        return { solvable: true, minimumMoves: 0, solution: [] };
    const goalMask = 0;
