...
// Mount all routes
router.use("/auth", auth_google_pkce_routes_1.default); // Google OAuth PKCE routes
router.use("/auth", auth_routes_1.default); // Other auth routes (login, register, refresh, etc.)
