...
const clean_recipes_routes_1 = __importDefault(require("./clean-recipes.routes"));
...
router.use("/api/clean-recipes", clean_recipes_routes_1.default);
console.log("    -> cleanRecipesRoutes loaded?", typeof clean_recipes_routes_1.default, "stackLength", (_d = clean_recipes_routes_1.default === null || clean_recipes_routes_1.default === void 0 ? void 0 : clean_recipes_routes_1.default.stack) === null || _d === void 0 ? void 0 : _d.length);
console.log("  Mounting /api → grocery routes");
router.use("/api", grocery_routes_1.default);
console.log("    -> groceryRoutes loaded?", typeof grocery_routes_1.default, "stackLength", (_e = grocery_routes_1.default === null || grocery_routes_1.default === void 0 ? void 0 : grocery_routes_1.default.stack) === null || _e === void 0 ? void 0 : _e.length);
console.log("  Mounting / → profile routes");
router.use("/", profile_1.default);
console.log("    -> profileRoutes loaded?", typeof profile_1.default, "stackLength", (_f = profile_1.default === null || profile_1.default === void 0 ? void 0 : profile_1.default.stack) === null || _f === void 0 ? void 0 : _f.length);
console.log("  Mounting /api → profile features routes");
router.use("/api", profileFeatures_routes_1.default);
console.log("    -> profileFeatures loaded?", typeof profileFeatures_routes_1.default, "stackLength", (_g = profileFeatures_routes_1.default === null || profileFeatures_routes_1.default === void 0 ? void 0 : profileFeatures_routes_1.default.stack) === null || _g === void 0 ? void 0 : _g.length);
