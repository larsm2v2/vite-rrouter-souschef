...
router.get("/grocery-list/version", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/grocery-list/version", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const controller = tsyringe_1.container.resolve(ShoppingListController_1.ShoppingListController);
    return controller.create(req, res);
}));
