...
exports.GetAlreadyStocked = void 0;
const tsyringe_1 = require("tsyringe");
const AlreadyStockedRepository_1 = require("../03_adapters/repositories/AlreadyStockedRepository");
let GetAlreadyStocked = class GetAlreadyStocked {
    constructor(alreadyStockedRepository) {
        this.alreadyStockedRepository = alreadyStockedRepository;
    }
    execute(userId) {
...
exports.GetAlreadyStocked = GetAlreadyStocked;
exports.GetAlreadyStocked = GetAlreadyStocked = __decorate([
