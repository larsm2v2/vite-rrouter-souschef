...
const SousChef: React.FC<SousChefProps> = ({
  ...
  const [inputMode, setInputMode] = useState<"askAway" | "specific">("askAway"); // New state for input mode
  const textToType =
  ...
  const getResponse = async () => {
    ...
    try {
      ...
      const cleanedJsonString = cleanedJsonMatch ? cleanedJsonMatch[0] : ""; // Use the match or an empty string if no match is found
  ...
  return (
    <div className="souschef-prompt">
      ...
      <div className="input-mode-toggle">
        <button
          className={inputMode === "askAway" ? "highlighted" : "unhighlighted"}
        ...
        <p> | </p>
        <button
          className={inputMode === "specific" ? "highlighted" : "unhighlighted"}
